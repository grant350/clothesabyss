//$(window).load(function(){$(document).fadeIn("slow") })
  
jQuery( document ).ready(function() {
/*
  import {footerClick} from './custom_js';
 import {flickity_size} from './flickity-resize';
    ...
    _createLineItemList: function(state) {
      return $.map(
        ...
        function(item, index) {
          ...
          this._setLineItemImage($item, item.z);
...
theme.Product = (function() {
  function Product(container) {
    ...
    this.settings = {
      ...
      productImageWraps: '.product_images',
      productThumbImages: '.product-single__thumbnail-' + sectionId,
      productThumbs:   '.product-single__thumbnail-image-' + sectionId,
      productThumbListItem: '.product-thumbnails-li',
      productFeaturedImage: '.product_images',
  ...
  Product.prototype = _.assignIn({}, Product.prototype, {
    ...
    _updateCartPopupContent: function(item) {
      ...
      this._setCartPopupImage(item.z.url, item.z.alt);
...
//login button show and hide when logged in
var clicks=0
var clicks_a =0
...
$( window ).resize(function(){console.log("window resize"); var x = $(window).width(), y = $(window).height(); console.log(x + " this is width"); console.log(y + " this is height"); $( ".collection-hero__image,.hero-about-image").css({"width":` ${x}` }); console.log($( ".collection-hero__image,.hero-about-image" ).width()); /*$(".center-login").css("height","auto"); var Disabled_center_login_height = $(".center-login").height() + 50; console.log(center_login_height); $(".center-login").css("height",`${center_login_height}`);*/ });
  ...
  if (thumbnails.length) {
    thumbnails.bind('click', function() {
      ...
      var strExtention = arrImage.pop();
            console.log(strExtention + "strExtension")

      var strRemaining = arrImage.pop().replace(/_[a-zA-Z0-9@]+$/,'');
      console.log(strRemaining + "strRemaining")
...
});//i is looping option 1 2 4 5 same grey black
